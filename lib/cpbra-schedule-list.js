...
export class CpbraScheduleList extends DDDSuper(LitElement) {
    ...
    constructor() {
        super();
        this.schedule_data = [];
        this.schedule_api = "/api/schedule";
        this.loading = true;
    ...
    async fetch_schedule_data() {
        ...
        try {
            ...
            this.schedule_data = [
                { opponent: "Dragons FC", date: "Fri, Dec 12", time: "8:00 PM", location: "Stadium One", status: "Live" },
                { opponent: "Titans United", date: "Sun, Dec 14", time: "2:00 PM", location: "Gym B", status: "Upcoming" },
                { opponent: "Wildcats 82", date: "Wed, Dec 17", time: "7:30 PM", location: "The Cage", status: "Completed" },
                { opponent: "Raptors Elite", date: "Sat, Dec 20", time: "4:00 PM", location: "Stadium One", status: "Canceled" }
            ];
        } finally {
            this.loading = false;
        }
